...
namespace Product.API.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateProductQuantities([FromBody] List<ProductUpdateDTO> productUpdates)
        {
            try
            {
                await _product.UpdateProductQuantitiesAsync(productUpdates);
